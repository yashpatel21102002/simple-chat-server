...
function sendMessage(ws: CustomWebSocket, type: string, payload: any) {
...
wss.on("connection", (ws: CustomWebSocket) => {
    ...
    ws.on('message', (messageBody: string) => {
        try {
            const data: messageBody = JSON.parse(messageBody);
            ...
            switch (actionType) {
                ...
                case 'join-room': {
                    ...
                    room.forEach((client: CustomWebSocket) => {
